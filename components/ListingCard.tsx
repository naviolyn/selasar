  ...
  return (
    <article className="w-full rounded-card bg-white shadow-sm shadow-ink/5 overflow-hidden border border-line/70">
      ...
      <div className="p-4 pt-3">
        ...
        {/* TODO: kalau user sudah login (cek via auth-context), arahkan ke
            /claim/[id]/confirm alih-alih /register. Untuk sekarang, guest
            yang belum daftar diarahkan daftar dulu sebelum bisa klaim. */}
        <a
          href="/register"
