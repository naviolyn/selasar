  ...
  return (
    <main className="min-h-screen bg-cream">
      <header className="border-b border-line bg-white/70 backdrop-blur sticky top-0 z-10">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-3 sm:py-4 flex flex-wrap items-center justify-between gap-x-4 gap-y-2">
          <div className="font-display text-lg sm:text-xl font-bold text-forest-dark whitespace-nowrap">
            SELASAR{" "}
            <span className="text-ink/40 font-normal text-xs sm:text-sm">· Mitra</span>
          </div>
          <div className="flex items-center gap-3 sm:gap-4 ml-auto">
            <a
              href="/Mitra/Pesanan"
              className="text-xs sm:text-sm font-medium text-ink/60 hover:text-ink transition-colors whitespace-nowrap"
            >
              Kelola Pesanan
            </a>
            <span className="text-sm text-ink/60 hidden md:inline whitespace-nowrap">
              Halo, {mitraName}
            </span>
            <button
              onClick={handleLogout}
              className="text-xs sm:text-sm font-medium text-ink/60 hover:text-clay transition-colors whitespace-nowrap"
            >
              Keluar
            </button>
          </div>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-6 sm:py-8 space-y-6 sm:space-y-8">
        <section className="grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4">
          ...
          <div className="bg-white rounded-card border border-line p-4 sm:p-5 col-span-2 sm:col-span-1">
          ...
          <section>
            ...
            <div className="space-y-3">
              {claims.map((c) => (
                <div
                  key={c.id}
                  className="bg-white rounded-card border border-forest/30 p-4 flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-4"
                >
